...
import { ShoppingCart, Bell, X, LogOut, User } from "lucide-react";
...
const Header = () => {
  ...
  const userData = typeof window !== 'undefined' ? localStorage.getItem("klimaUser") : null;
  ...
  // Generate initials: e.g. james.nyangoma → JN, john@ → JO, a@b.com → AB
