// app/components/SocialScorecardTable.tsx
        ...
        <section className="w-full mx-auto px-4 py-8 md:px-12">
            ...
            <div className="overflow-x-auto bg-gray-white">
                <table className="w-full text-sm text-left text-gray-700 border-separate border-spacing-4">
                    <thead>
                        <tr>
                            <th className="px-6 py-4 font-semibold text-teal-900 bg-[#FFF8E8] rounded-lg">Activity</th>
                            <th className="px-6 py-4 font-semibold text-teal-900 text-center bg-[#FFF8E8] rounded-lg">
                                Baseline Year
                            </th>
                            <th className="px-6 py-4 font-semibold text-teal-900 text-center bg-[#FFF8E8] rounded-lg">
                                Target Year
                            </th>
                            <th className="px-6 py-4 font-semibold text-teal-900 bg-[#FFF8E8] rounded-lg text-center">
                                Progress & Status
                            </th>
                            <th className="px-8 py-6 font-semibold text-teal-900 text-center bg-[#FFF8E8] rounded-lg min-w-[200px]">
                                SDGs
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        {tableData.map((row, index) => (
                            <tr key={index}>
                                <td className="px-6 py-5 font-medium text-gray-800 bg-[#FFF8E8] rounded-lg border-b border-gray-400">
                                    {row.activity}
                                </td>
                                <td className="px-6 py-5 text-center bg-[#FFF8E8] rounded-lg border-b border-gray-400">
                                    {row.baselineYear}
                                </td>
                                <td className="px-6 py-5 text-center bg-[#FFF8E8] rounded-lg border-b border-gray-400">
                                    {row.targetYear}
                                ...
                                <td className="px-6 py-5 bg-[#FFF8E8] rounded-lg border-b border-gray-400">
                                ...
                                {index === 0 && (
                                    <td
                                        ...
                                        className="px-8 py-10 bg-[#FFF8E8] rounded-lg align-middle border-b border-gray-400"
                                    >
...
export default SocialScorecardTable;